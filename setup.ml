...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5ebbc0c9b0a05b50ef520c242de74eda) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "./src/app/";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "bracetax"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "API reference for bracetax";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest =
       Some "\244\177\233\026Y\169Y\190\187P\001\182\178`\200\203";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
